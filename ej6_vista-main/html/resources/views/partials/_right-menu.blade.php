        ...
        <div class="h-screen overflow-y-scroll">
            ...
            <div class="flex justify-center">
                <div class="p-5 pb-0 relative w-full">
                    ...
                    <input type="search" name="search" placeholder="Buscar en SnippetConnect"
                ...
                <div class="bg-gray-100 m-4 overflow-hidden rounded-lg shadow-lg">
                    <div class="flex">
                        <div class="flex-1 m-2">
                            <h2 class="font-semibold px-4 py-2 text-gray-900 text-xl w-48">
                                Siguiendo
                            </h2>
                        </div>
                    </div>
            ...
            @else
                ...
                <img src="{{ asset('images/image-fragment-code.png') }}" alt="Imagen banner" class = "px-5" >
